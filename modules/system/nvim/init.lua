...
vim.keymap.set("n", "<leader>i2", ":%s/  /\\t/g<CR>", { desc = "Switch [I]ndentation from [2] spaces to tabs" })
vim.keymap.set("n", "<leader>i4", ":%s/    /\\t/g<CR>", { desc = "Switch [I]ndentation from [4] spaces to tabs" })
...
require("nixCatsUtils.lazyCat").setup(nixCats.pawsible({ "allPlugins", "start", "lazy.nvim" }), {
	...
	{ -- https://github.com/KostkaBrukowa/nvim-config/blob/master/lua/plugins/typescript-tools.lua
